<nav class="navbar navbar-expand-lg navbar-dark primary-color py-4">
  <a class="navbar-brand" href="index.jsp"> <span class="fa fa-certificate"></span> BloggersSpot</a>
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="index.jsp"> <span class="fa fa-home"></span> Home <span class="sr-only">(current)</span></a>
            ...
            <li class="nav-item">
        <a class="nav-link" href="contact.jsp"><span class="	fa fa-phone-square"></span> About us</a>
      </li>
  
           <li class="nav-item">
        <a class="nav-link" href="LogIn.jsp"><span class="fa fa-user-circle-o "></span></span> Login</a>
      </li>
